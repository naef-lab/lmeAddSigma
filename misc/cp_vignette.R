paper.dir <- "~/R/D/bitbucket/lmeAddSigma_misc/papers/lmer_JSS"
paper.dir <- "~/R/lmeAddSigma_misc/papers/lmer_JSS"

## assume we start in lmeAddSigma/misc, but lmeAddSigma/vignettes works, too:
...
if(!file.exists(lmerSrc)) {
    ...
    stop("Cannot setwd(",vignette.dir,"). Must run inside  lmeAddSigma/misc/")
} else {
